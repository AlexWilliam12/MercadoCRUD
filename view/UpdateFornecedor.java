...
public class UpdateFornecedor extends JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Tela de atualizar Fornecedor");
        setResizable(false);
        ...
        jButton1.addActionListener(ControllerFornecedor.buscarUpdateCEP());

        jButton2.setBackground(new Color(0, 0, 0));
        jButton2.setFont(new Font("Segoe UI", 1, 12));
        jButton2.setForeground(new Color(255, 255, 255));
        jButton2.setText("FINALIZAR");
        jButton2.addActionListener(ControllerFornecedor.updateFornecedor());
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                    .addComponent(jTextField9, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(jTextField11, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)
                                        .addComponent(jTextField10, GroupLayout.Alignment.LEADING))
                                    .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jTextField7, GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
                                        ...
                                        .addComponent(jTextField8, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(72, 72, 72)
